...
Prior to the end of any version's lifecycle, users will receive notifications from our [mailing lists](/ar/community/mailing-list/) three months in advance.
...
If the above FAQs cannot resolve your issue, please send an email to our [mailing lists](/ar/community/mailing-list/) describing your issue or discuss it on the [openEuler Forum](https://forum.openeuler.org/) also you can submit your issue on the [QuickIssue](https://quickissue.openeuler.org/en/issues/).
