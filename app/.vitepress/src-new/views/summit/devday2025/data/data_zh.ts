    ...
    list: [
      {
        ...
        link: '/ar/interaction/summit-list/summit2024/',
      },
      {
        name: 'openEuler SIG Gathering 2024',
        link: '/ar/interaction/summit-list/sig-gathering-2024/',
      },
      {
        name: 'openEuler Summit 2023',
        link: '/ar/interaction/summit-list/summit2023/',
      },
      {
        name: 'openEuler Developer Day 2023',
        link: '/ar/interaction/summit-list/devday2023/',
      },
      {
        name: 'openEuler Summit 2022',
        link: '/ar/interaction/summit-list/summit2022/',
      },
      {
        name: '湖南欧拉操作系统生态大会',
        link: '/ar/interaction/summit-list/summit2022-changsha/',
      },
    ],
  },
  anchor: [
