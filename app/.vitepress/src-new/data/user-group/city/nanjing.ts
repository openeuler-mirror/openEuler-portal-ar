  ...
  news: [
    {
      ...
      path: 'ar/news/openEuler/20240625-nanjing/20240625-nanjing',
    },
    {
      ...
      path: 'ar/news/20230609-nanjing/20230609-nanjing',
    },
  ],
  showcase: [
    {
      summary: 'openEuler在汽车零部件装配线曲线管理系统中的应用',
      path: 'ar/showcase/others/yinhu/',
      industry: '其他',
      title: '南京银湖数字技术有限公司',
    },
    {
    ...
    },
    {
      ...
      path: 'ar/showcase/energy/hanyuan/',
      industry: '能源',
    ...
    },
    {
      ...
      path: 'ar/showcase/education/nanxinda/',
      industry: '高校&科研',
