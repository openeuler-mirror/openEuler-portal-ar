  ...
  news: [
    {
      ...
      path: 'ar/news/openEuler/20240628-changsha/20240628-changsha',
    },
    {
      summary:
      ...
      path: 'ar/news/20230915-hunan/20230915-hunan',
    },
  ],
  showcase: [
    {
      summary: '长沙智慧民政国产操作系统迁移，树立政务系统建设优秀示范',
      path: 'ar/showcase/others/changsha/',
      industry: '其他',
      title: '长沙市民政局',
    },
    {
      summary: '基于麒麟信安打造银行IT信息化系统安全底座',
      path: 'ar/showcase/finance/xiangjiang/',
      industry: '金融',
      title: '三湘银行',
    },
    {
