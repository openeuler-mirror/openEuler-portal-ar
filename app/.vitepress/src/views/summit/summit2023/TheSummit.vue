...
function goLive(index: number) {
  router.go(`/interaction/summit-list/summit2023/?live=${index}`);
}
onMounted(() => {
  ...
  <AppContext>
    ...
    <div class="agenda">
      ...
      <div class="schedule-box">
        <el-tabs v-model.number="tabType" class="schedule-tabs">
          <el-tab-pane :name="0">
            <template #label>
              <div v-if="lang === 'ar'" class="time-tabs">
                {{
                  showIndex === 0
        ...
        <p v-if="lang === 'ar'" class="time-tip">*Time zone: GMT+8</p>
    ...
    <div class="guest">
      <h3 class="guest-title">
        {{ lang === 'ar' ? summitData.guest.titleAr : summitData.guest.titleEn }}
      </h3>
      <h4>
        {{
          lang === 'ar'
            ? summitData.guest.guestListOperational.titleAr
      ...
      <h4>
        {{
          lang === 'ar'
            ? summitData.guest.guestListMain.titleAr
      ...
      <h4>
        {{
          lang === 'ar'
            ? summitData.guest.guestListEducation.titleAr
      ...
      <h4>
        {{
          lang === 'ar'
            ? summitData.guest.guestListProducer.titleAr
      ...
      <h4>
        {{
          lang === 'ar'
            ? summitData.guest.guestListTechnology.titleAr
