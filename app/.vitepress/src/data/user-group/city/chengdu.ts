  ...
  news: [
    {
      ...
      tags: ['openEuler'],
      path: 'news/20231127-cs/20231127-cs',
      lang: 'ar',
      category: 'news',
    },
  ],
  showcase: [
    {
      ...
      path: 'showcase/others/starvcenter/',
    ...
    },
    {
      ...
      path: 'showcase/others/jingrong2/',
      img: '/category/showcase/others.png',
      articleName: 'index.md',
      banner: '/category/showcase/case-detail-bg.jpg',
      textContent:
    ...
    },
    {
      ...
      path: 'showcase/others/zhongdian/',
      img: '/category/showcase/others.png',
      articleName: 'index.md',
      banner: '/category/showcase/case-detail-bg.jpg',
      textContent:
    ...
    },
    {
      ...
      path: 'showcase/others/jingrong1/',
      img: '/category/showcase/others.png',
      articleName: 'index.md',
      banner: '/category/showcase/case-detail-bg.jpg',
      textContent:
