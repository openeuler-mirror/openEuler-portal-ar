...
export default {
  ar: {
    memberList: [
      {
        title: 'اللجنة الاستشارية للجنة openEuler',
        list: [
          {
            img: lusouqun,
            name: 'Lu Shouqun',
      ...
      {
        title: 'لجنة openEuler الفنية',
        list: [
          {
            img: huxinwei,
            name: 'Hu Xinwei',
            post: 'رئيس مجلس الإدارة',
      ...
      {
        title: 'لجنة openEuler التسويقية',
        list: [
          {
            img: liangbin,
            name: 'Liang Bing',
    ...
    notice: 'الملاحظة: يتم ترتيب الأسماء حسب الترتيب الأبجدي.',
  },
};
