  ...
  EULER_TASK_ITEM: [
    {
      NAME: 'Kernel',
      NAME_LINK:
        'https://www.openeuler.org/sig/sig-detail/?id=10&name=Kernel',
    ...
    },
    {
      NAME: 'sig-QA',
      NAME_LINK:
        'https://www.openeuler.org/sig/sig-detail/?id=41&name=sig-QA',
    ...
    },
    {
      NAME: 'sig-openstack',
      NAME_LINK:
        'https://www.openeuler.org/sig/sig-detail/?id=59&name=sig-openstack',
      INTRODUCE:
    ...
    },
    {
      NAME: 'A-tune',
      NAME_LINK:
        'https://www.openeuler.org/sig/sig-detail/?id=1&name=A-Tune',
    ...
    },
    {
      ...
      NAME_LINK:
        'https://www.openeuler.org/sig/sig-detail/?id=37&name=sig-KIRAN-DESKTOP&mail=dev%40openeuler.org',
      INTRODUCE:
    ...
    },
    {
      NAME: 'sig-ops',
      NAME_LINK:
        'https://www.openeuler.org/sig/sig-detail/?id=83&name=sig-ops',
    ...
    },
    {
      NAME: 'Cloud Native',
      NAME_LINK:
        'https://www.openeuler.org/sig/sig-detail/?id=85&name=sig-CloudNative',
      INTRODUCE:
    ...
    {
      NAME: 'G11N',
      NAME_LINK: 'https://www.openeuler.org/sig/sig-detail/?id=98&name=G11N',
    ...
    },
    {
      NAME: 'sig-UKUI',
      NAME_LINK:
        'https://www.openeuler.org/sig/sig-detail/?id=46&name=sig-UKUI',
      INTRODUCE:
    ...
    },
    {
      NAME: 'sig-OSCourse',
      NAME_LINK:
        'https://www.openeuler.org/sig/sig-detail/?name=sig-OSCourse',
    ...
    {
      NAME: 'sig-DDE',
      NAME_LINK: 'https://www.openeuler.org/sig/sig-detail/?name=sig-DDE',
    ...
    },
    {
      NAME: 'Infrastructure',
      NAME_LINK:
        'https://www.openeuler.org/sig/sig-detail/?name=Infrastructure',
    ...
    },
    {
      NAME: 'sig-OS-Builder',
      NAME_LINK:
        'https://www.openeuler.org/sig/sig-detail/?name=sig-OS-Builder',
      INTRODUCE:
    ...
    {
      NAME: 'sig-CICD',
      NAME_LINK: 'https://www.openeuler.org/sig/sig-detail/?name=sig-CICD',
      INTRODUCE:
    ...
    {
      NAME: 'sig-HPC',
      NAME_LINK: 'https://www.openeuler.org/sig/sig-detail/?name=sig-HPC',
      INTRODUCE:
    ...
    {
      NAME: 'sig-Virt',
      NAME_LINK: 'https://www.openeuler.org/sig/sig-detail/?name=Virt',
      INTRODUCE:
    ...
    },
    {
      ...
      NAME_LINK:
        'https://www.openeuler.org/sig/sig-detail/?name=sig-Compatibility-Infra',
    ...
    {
      NAME: 'Compiler',
      NAME_LINK: 'https://www.openeuler.org/sig/sig-detail/?name=Compiler',
      INTRODUCE:
    ...
    {
      NAME: 'AI SIG',
      NAME_LINK: 'https://www.openeuler.org/sig/sig-detail/?name=ai',
      INTRODUCE:
    ...
    {
      NAME: 'sig-BigData',
      NAME_LINK: 'https://www.openeuler.org/sig/sig-detail/?name=bigdata',
      INTRODUCE:
    ...
    {
      NAME: 'sig-SDS',
      NAME_LINK: 'https://www.openeuler.org/sig/sig-detail/?name=sig-SDS',
    ...
    {
      NAME: 'sig-AccLib',
      NAME_LINK: 'https://www.openeuler.org/sig/sig-detail/?name=sig-AccLib',
    ...
    },
    {
      NAME: 'sig-FangTian',
      NAME_LINK:
        'https://www.openeuler.org/sig/sig-detail/?name=sig-FangTian',
      INTRODUCE:
      ...
      GITEE: 'https://www.openeuler.org/sig/sig-detail/?name=sig-FangTian',
    },
    {
      NAME: 'sig-memsafety',
      NAME_LINK:
        'https://www.openeuler.org/sig/sig-detail/?name=sig-memsafety',
    ...
    {
      NAME: 'sig-dev-utils',
      NAME_LINK: 'https://www.openeuler.org/sig/sig-detail/?name=dev-utils',
